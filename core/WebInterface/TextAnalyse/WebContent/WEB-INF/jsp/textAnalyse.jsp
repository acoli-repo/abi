		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
						<h2>
							<span>Text Analyse</span>
						</h2>
					</div>
					<div id="wrapperanalyse">
						<div id="welcome-analyse" class="container">
							<h4>
								<span>SparQL Abfrage</span>
							</h4>
							Bitte geben Sie Ihre SparQL Anfrage ein: <br />
							<form:form method="post" action="successSparQl.html"
								commandName="ta">

								<table>
									<tr>
										<td><form:textarea path="spql" row="10" col="60"></form:textarea>
										</td>
										
									</tr>
									<tr>
										<td><form:errors path="spql" cssClass="error" /></td>
									</tr>
									<tr>
