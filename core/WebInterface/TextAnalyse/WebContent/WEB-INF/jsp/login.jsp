...
<head>
<title>Text Analytics | login</title>
			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="login.html">Verwaltung</a></li>
						...
						<section class="container-login">
							...
							<div class="login">
								...
								<form:label path="username">Enter your user-name</form:label>
						            ...
						            <form:input id="username" name="username" path="username" placeholder="Username" /><br>
						            <form:errors path="username" cssClass="error" /><br>
						            <form:label path="username">Please enter your password</form:label>
						
						            <form:password id="password" name="password" path="password" placeholder="Password"/><br>
									<form:errors path="password" cssClass="error" /><br>
									
									<p class="submit">
										<input type="submit" name="commit" value="verwaltung">
									</p>
								</form:form>
							</div>
							...
							<div class="login-help">
								<p>
									Forgot your password? <a href="contact.html"> Click here to
										contact us</a>
								</p>
							</div>
						</section>
